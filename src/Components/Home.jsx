...
const Home = () => {
  return (
    <div className="bg-neutralSliver" id="home">
      <div
        className="px-4 lg:px-14 max-w-screen-2xl mx-auto min-h-screen h-screen navbar-container"
        ...
        <Carousel className="w-full max-auto" style={{ height: "400px" }}>
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12">
            ...
            <div className="md:w-1/2">
              <h1 className="text-2xl md:text-5xl mb-3 text-neutralDGrey md:w-3/4 leading-snug car-h1">
              ...
              <p className="text-neutralGrey text-base mb-8">
                ...
                to meet your evolving business needs. Lets innovate together
          ...
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-neutralGrey text-base mb-5">
                ...
                our solutions empower businesses to thrive in todays dynamic
          ...
          <div className="my-28 md:my-8 py-12 flex flex-col md:flex-row-reverse items-center justify-between gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-neutralGrey text-base mb-5">
                ...
                Raddotechs collaborative tools and platforms. Whether its
